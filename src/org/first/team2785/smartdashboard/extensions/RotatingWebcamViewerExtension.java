package org.first.team2785.smartdashboard.extensions;
 ...
 * @author Ryan Cahoon
 */
public class RotatingWebcamViewerExtension extends StaticWidget implements Runnable {

    public static final String NAME = "Rotating USB Webcam Viewer";
    ...
    public RotatingWebcamViewerExtension() {
        super();
    ...
    protected void paintComponent(Graphics g) {
        ...
        synchronized (this.frameMutex) {
            // shamelessly copypasted from VideoStreamViewerExtension (seriously WPI)
            ...
            if (this.frame != null) {
                ...
                int origImageWidth = this.frame.getWidth();
                int origImageHeight = this.frame.getHeight();
                ...
                double rotateAngleRad = Math.toRadians(rotateProperty.getValue());
                ...
                g2d.drawImage(this.frame, -imageCenterX, -imageCenterY, null);
